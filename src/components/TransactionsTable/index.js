...
function TransactionsTable({transactions, addTransaction, fetchTransactions}) {
                ...
                complete: async function (results) {
                    ...
                    for (const transaction of results.data) {
                        ...
                        if (!isNaN(parsedAmount)) {
                            ...
                            console.log("Skipping transaction with invalid amount:", transaction);
                        }
                    }
                },
            });
  ...
  return (
   ...
   <div className='input-flex'>
        ...
        <Radio.Group className="input-radio" onChange={(e) => setSortkey(e.target.value)} value={setSortkey}>
